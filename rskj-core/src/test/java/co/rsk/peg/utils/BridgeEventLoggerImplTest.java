...
public class BridgeEventLoggerImplTest {
    ...
    public void logLockBtc() {
        ...
        eventLogger.logLockBtc(mockedTx, senderAddress, rskAddress, Coin.SATOSHI);
        ...
        byte[] expectedData = RLP.encodeList(RLP.encodeString("a-tx-hash"), RLP.encodeString(senderAddress.toString()),
                              RLP.encodeRskAddress(rskAddress), RLP.encodeString(Coin.SATOSHI.toString()), RLP.encodeElement(Hex.decode("1122334455")));
